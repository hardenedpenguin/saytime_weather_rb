...
```bash
cd /tmp
wget https://github.com/hardenedpenguin/saytime_weather_rb/releases/download/v0.0.25/saytime-weather-rb_0.0.25-1_all.deb
sudo apt install ./saytime-weather-rb_0.0.25-1_all.deb
```
